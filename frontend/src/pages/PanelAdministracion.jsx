        ...
        <>
            ...
            <div className="w-full md:max-w-[768px] xl:max-w-7xl p-4 md:p-6 xl:p-3 bg-white rounded-lg shadow-md mx-auto text-center">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 md:gap-4">
                    ...
                    <div className="p-3 md:p-4 bg-orange-500 hover:bg-orange-600 text-white rounded-lg shadow transition-colors">
                    ...
                    <div className="p-3 md:p-4 bg-purple-500 hover:bg-purple-600 text-white rounded-lg shadow transition-colors">
                        <Link to={`/seleccionar-evento-ticket`} className="block">
            ...
            <div className="mt-6 flex justify-center">
                <button
                    ...
                    className="bg-red-500 text-white px-6 py-3 rounded-lg shadow-md hover:bg-red-600 transition-all text-sm md:text-base font-semibold"
                >
                    Cerrar Sesión
                </button>
            </div>
